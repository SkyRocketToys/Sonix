...
#define PORT_ARM926EJS_SONIX					16	/*	No			FreeRTOS	*/
...
#elif (SELECTED_PORT == PORT_ARM926EJS_SONIX)
#include <bsp.h>
#include <interrupt.h>

	#define HWTC_COUNT_DIRECTION DIRECTION_DECREMENTING
	#define HWTC_COUNT (*(volatile unsigned int*)0x98600000)
	//#define HWTC_PERIOD 1
	//#define HWTC_PERIOD (configCPU_CLOCK_HZ / configTICK_RATE_HZ)
	#define HWTC_PERIOD (configTIMER_CLOCK_HZ / configTICK_RATE_HZ)
	#define HWTC_DIVISOR 1
