...
bool mavlink_message_send_args(int argc, char **argv)
{
    ...
    for (i=1; i<=argc; i++) {
        ...
        case MAVLINK_TYPE_UINT8_T:
            _mav_put_uint8_t(buf, f->wire_offset, simple_strtoul(arg, NULL, 0));
            break;

        case MAVLINK_TYPE_UINT16_T:
            _mav_put_uint16_t(buf, f->wire_offset, simple_strtoul(arg, NULL, 0));
            break;

        case MAVLINK_TYPE_UINT32_T:
            _mav_put_uint32_t(buf, f->wire_offset, simple_strtoul(arg, NULL, 0));
            break;

        case MAVLINK_TYPE_UINT64_T:
            _mav_put_uint64_t(buf, f->wire_offset, simple_strtoul(arg, NULL, 0));
            break;
        ...
        case MAVLINK_TYPE_INT64_T:
            _mav_put_int64_t(buf, f->wire_offset, strtol(arg, NULL, 0));
            break;
